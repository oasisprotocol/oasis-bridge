...
if [ ! -e "untracked/oasis-core-runtime-loader-$BUILD_NUMBER" ]; then
    wget -O "untracked/oasis-core-runtime-loader-$BUILD_NUMBER" "$OASIS_CORE_RUNTIME_LOADER_ARTIFACT"
    chmod +x "untracked/oasis-core-runtime-loader-$BUILD_NUMBER"
fi
if [ ! -e "untracked/simple-keymanager-$BUILD_NUMBER" ]; then
    wget -O "untracked/simple-keymanager-$BUILD_NUMBER" "$SIMPLE_KEYMANAGER_ARTIFACT"
